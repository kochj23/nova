#!/usr/bin/env python3
"""
nova_philosophy_ethics_ingest.py — Recursive Wikipedia ingest starting from Management, Ethics, Morality, Dualism, Atheism, and Agnosticism.

Crawls from Management, Ethics, Morality, Dualism, Atheism, and Agnosticism pages, follows links, classifies content into
...
START_URLS = ["https://en.wikipedia.org/wiki/Management", "https://en.wikipedia.org/wiki/Ethics", "https://en.wikipedia.org/wiki/Morality", "https://en.wikipedia.org/wiki/Dualism_in_cosmology", "https://en.wikipedia.org/wiki/Atheism", "https://en.wikipedia.org/wiki/Agnosticism"]

# Music sub-vector classification
VECTOR_CATEGORIES = {
    "philosophy_ethics": [
        "ethics", "moral", "virtue", "duty", "consequentialism",
        "deontology", "utilitarianism", "categorical imperative",
        "golden rule", "right", "wrong", "justice", "fairness",
    ],
    "philosophy_metaphysics": [
        "metaphysics", "ontology", "dualism", "monism", "cosmology",
        "existence", "reality", "being", "substance", "causation",
        "determinism", "free will", "consciousness",
    ],
    "philosophy_epistemology": [
        "epistemology", "knowledge", "belief", "truth", "justification",
        "skepticism", "rationalism", "empiricism", "a priori",
    ],
    "religion_atheism": [
        "atheism", "atheist", "secularism", "secular", "nonbelief",
        "antitheism", "freethought", "rationalist", "humanism",
        "dawkins", "hitchens", "new atheism",
    ],
    "religion_agnosticism": [
        "agnosticism", "agnostic", "uncertainty", "unknowable",
        "huxley", "ignosticism", "apatheism",
    ],
    "religion_theology": [
        "god", "theology", "religion", "theism", "deism",
        "monotheism", "polytheism", "pantheism", "creation",
        "divine", "sacred", "faith", "worship",
    ],
    "philosophy_political": [
        "political philosophy", "social contract", "liberty", "rights",
        "democracy", "sovereignty", "authority", "power",
        "marxism", "liberalism", "conservatism", "anarchism",
    ],
    "philosophy_mind": [
        "philosophy of mind", "consciousness", "qualia", "intentionality",
        "mind-body", "functionalism", "physicalism", "dualism",
        "artificial intelligence", "turing test", "chinese room",
    ],
    "management_leadership": [
        "management", "leadership", "organization", "decision",
        "strategy", "planning", "coordination", "hierarchy",
        "stakeholder", "governance", "accountability",
    ],
    "philosophy_history": [
        "history", "ancient", "medieval", "modern", "socrates",
        "plato", "aristotle", "kant", "hegel", "nietzsche",
        "descartes", "hume", "locke", "mill",
    ],
    "philosophy_general": [],  # fallback
}
...
def log(msg):
    ...
    print(f"[philosophy-ingest {ts}] {msg}", flush=True)
...
def post_status():
    ...
    msg = (
        f":brain: *Philosophy/Ethics Wikipedia Ingest* — {pct:.1f}%\n"
...
def main():
    ...
    log(f"Starting Philosophy/Ethics Wikipedia ingest — target: {TARGET_CHUNKS} chunks")
    log(f"Start URLs: {START_URLS}")

    notify(
        f":guitar: *Philosophy/Ethics Wikipedia Ingest Starting*\n"
        f"• Sources: Management, Ethics, Morality, Dualism, Atheism, Agnosticism\n"
    ...
    notify(
        f":checkered_flag: *Philosophy/Ethics Ingest Complete!*\n"
